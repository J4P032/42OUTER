...
impl Ticket {
    pub fn title(&self) -> &str {
        self.title.trim()//el metodo trim es de &str no de String pero con el Deref Coertion lo hacemos hacia &str.
        //pero ha de ser no una referencia, sino que pasa un puntero gordo.. en tonde se actualiza el origen del puntero
        //saltándose los espacios y la longitud del mismo para saltarse los espacios finales. 
   }
