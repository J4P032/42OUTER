...
fn easy_ticket(title: String, description: String, status: Status) -> Ticket {
    ...
    //necesario el .clone() por que si no se pierde el ownership y no se puede hacer el otro new del final con ticket ni status
    //description no lo usamos más asi que se puede perder si quiere el ownership
