...
impl TicketStore {
    ...
    /* 
        Para entender el impl DENTRO de una funcion o como lo que suelta.
        Cuando el impl está fuera es un "implementamos lo que sea para esta estructura, enum o lo que sea"
        Pero si está en una función es, "acepto esta variable que HAYA IMPLEMENTADO esto". Es decir para la de abajo:
        ticket: impl Into<Ticket> = "acepto un ticket que haya implementado el into() hacia tickets" 
